            ...
            <section class="bg-light text-dark text-center p-5">
                <div class="container">
                    ...
                    <div class="container mb-4 buttons d-inline-flex justify-content-center align-items-center">
                        <button type="button" class="btn d-sm-flex filters" id="searchButton">search<i
                                class="fas fa-caret-down p-1"></i></button>

                        <button type="button" class="btn d-sm-flex filters" id="filterButton">filter<i
                                class="fas fa-caret-down p-1"></i></i></button>
                        
                        <button type="button" class="btn d-sm-flex filters" id="sortButton">sort<i
                                class="fas fa-caret-down p-1"></i></i></button>
                    </div>
                    <!-- End of buttons -->

                    <!-- Search -->
                    <div class="container mb-3 searchInput" style="display: none; width: 85%;">
                    ...
                    <!-- Filter -->
                    <div style="display:none; width: 85%;" class="container mb-3 filterInput">
                    ...
                    <!-- Sort -->
                    <div class="container mb-3 sortInput" style="display: none; width: 85%;">
                        <div class="row g-4 justify-content-between align-items-center d-md-flex">
